...
('77777777-7777-7777-7777-777777777777', ARRAY['user', 'reset', 'password', 'access'], FALSE, 'As a user, I want to reset my password to regain access');

-- Создаём пользователя ilya
